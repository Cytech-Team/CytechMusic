...
class Karaoke(Filter):
    ...
    def __repr__(self):
        return (
            f"<Cytechlink.KaraokeFilter tag={self.tag} level={self.level} mono_level={self.mono_level} "
...
class Rotation(Filter):
    ...
    def __repr__(self) -> str:
        return f"<Cytechlink.RotationFilter tag={self.tag} rotation_hertz={self.rotation_hertz}>"
...
class Distortion(Filter):
    ...
    def __repr__(self) -> str:
        return (
            f"<Cytechlink.Distortion tag={self.tag} sin_offset={self.sin_offset} sin_scale={self.sin_scale}> "
